...
public class BadgeDrawable extends Drawable {
    ...
    public BadgeDrawable(Context context) {
        float mTextSize = context.getResources().getDimension(R.dimen.text_size_micro);

        mBadgePaint = new Paint();
        mBadgePaint.setColor(ContextCompat.getColor(context.getApplicationContext(),R.color.badge_icon_color));
